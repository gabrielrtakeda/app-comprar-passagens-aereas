...
import project.modules.Airport.View.Panel.AirportConsultPanel;
import java.awt.BorderLayout;
import javax.swing.BorderFactory;

public class AirportConsultTemplate extends AbstractTemplate
{
    public AirportConsultTemplate(ConfigurationEntity configuration)
    {
        ...
        add(new AirportConsultPanel(configuration), BorderLayout.CENTER);
    }
}
