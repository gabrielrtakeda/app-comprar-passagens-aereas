...
public class AirportEditContentTemplate extends AbstractTemplate
{
    public AirportEditContentTemplate(ConfigurationEntity configuration)
    {
        ...
        add(new AirportRegisterPanel(configuration), BorderLayout.CENTER);
    }
}
