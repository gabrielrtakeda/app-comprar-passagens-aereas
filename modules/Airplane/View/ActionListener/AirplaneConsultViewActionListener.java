...
public class AirplaneConsultViewActionListener extends AbstractActionListener
{
    public AirplaneConsultViewActionListener(ConfigurationEntity configuration)
    {
