...
import project.modules.Airplane.View.Panel.AirplaneMenuPanel;
import java.awt.BorderLayout;
import javax.swing.BorderFactory;

public class AirplaneMenuTemplate extends AbstractTemplate
{
    public AirplaneMenuTemplate(ConfigurationEntity configuration)
    {
        ...
        add(new AirplaneMenuPanel(configuration), BorderLayout.CENTER);
    }
}
